...
# A copy of speech-dispatcher Python API from https://github.com/brailcom/speechd adapted for a distro agnostic distribution
...
class SSIPClient(object):
    ...
    def _server_spawn(self, connection_args):
        ...
        if not cmd:
            cmd = "speech-dispatcher" #paths.SPD_SPAWN_CMD
